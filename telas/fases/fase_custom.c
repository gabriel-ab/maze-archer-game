...
void fase_custom(){
    ...
    while(telaAtual == TELA_FASE_CUSTOM && !WindowShouldClose()){
        TEMPO = GetTime();
        ...
        BeginDrawing();
            ...
            BeginMode2D(cam);
                ...
                for (int i = 0; i < fase.n_vidas; i++)
                {
                    ...
                    {
                        DrawCircleV(fase.vida[i].posicao, 16, BLACK);
                        drawSprite(fase.vida[i].sprite, fase.vida[i].posicao, (Vector2){0,0}, 0, 0.6, WHITE);
                ...
                for (int i = 0; i < fase.n_flechas; i++)
                {
                    ...
                    {
                        DrawCircleV(fase.flecha[i].posicao, 16, BLACK);
                        drawSprite(fase.flecha[i].sprite, fase.flecha[i].posicao, (Vector2){0,0}, 0, 0.8, WHITE);
        ...
        //=========================CONTROL===========================//
        if(IsKeyPressed(KEY_ESCAPE)) telaPausa();
